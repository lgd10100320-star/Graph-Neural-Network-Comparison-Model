...
METRICS_PATH = BASE_DIR / "rf_performance_metrics.txt"
FIGURE_PATH = BASE_DIR / "RF_Performance.png"
...
cross_validation = ShuffleSplit(n_splits=10, test_size=0.2, random_state=0)
